...
exports.default = function (app) {
  ...
  app.set('appPath', _path2.default.join(_environment2.default.root, 'fs'));
  app.use('/fs', _express2.default.static(app.get('appPath')));
  ...
  app.use((0, _multer2.default)({ dest: _path2.default.resolve('./uploads/') }));
